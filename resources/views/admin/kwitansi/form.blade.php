             ...
             <form id="formKu" class="needs-validation" novalidate>
                 ...
                 <div class="modal-body">
                     <div class="row">
                         ...
                         <div class="col-12 col-md-4">
                             <div class="mb-3">
                                 <label for="banyak" class="form-label">Banyaknya Uang</label>
                                 <input id="banyak" type="text" name="banyak" class="form-control currency inputReset"
                         ...
                         <div class="col-12 col-md-8">
                             <div class="mb-3">
                                 ...
                                 <input type="text" class="form-control inputReset" name="terbilang" id="terbilang"
                                     required>
                                 <div class="invalid-feedback">
                                     Data Tidak Boleh Kosong
                                 </div>
