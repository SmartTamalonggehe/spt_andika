...
var colors = ["#006dfc", "#ffb100", "#00ec00", "#ff0000", "#0000ff"];
var container = document.getElementById("chart-surat");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            console.log("dataByMonth", dataByMonth); // count data by jenis_surat
