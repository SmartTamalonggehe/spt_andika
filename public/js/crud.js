...
/***/ "./resources/js/my_crud/ubah-status.js":
/*!*********************************************!*\
  !*** ./resources/js/my_crud/ubah-status.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
$("body").on("click", ".btn-ubah-status", function (e) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().put("".concat(tools.uri, "/").concat(href)).then(function (response) {
        // lakukan sesuatu jika data sudah terkirim
        Swal.fire("Berhasil!", response.data.pesan, response.data.type);
        var oTable = $("#my_table").dataTable();
        oTable.fnDraw(false);
      })["catch"](function (error) {
        Swal.fire("Gagal!", error.response.data.pesan, error.response.data.type);
      });
    }
  });
});
...
__webpack_require__(/*! ./my_crud/ubah-status */ "./resources/js/my_crud/ubah-status.js");
})();
