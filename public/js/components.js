...
/***/ "./resources/js/components/select-pegawai.js":
/*!***************************************************!*\
  !*** ./resources/js/components/select-pegawai.js ***!
  \***************************************************/
...
var pegawai_id = document.getElementById("pegawai-id");

var selectPegawai = /*#__PURE__*/function () {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0,_getData__WEBPACK_IMPORTED_MODULE_1__.getDataPegawai)();

          case 2:
            dataPegawai = _context.sent;
            pegawai_id.innerHTML = "<option value=\"\" selected disabled>--Pilih Pegawai--</option>";
            dataPegawai.forEach(function (pegawai) {
              pegawai_id.innerHTML += "<option value=\"".concat(pegawai.id, "\">").concat(pegawai.NIP, "-").concat(pegawai.nama, "</option>");
            });
...
/***/ "./resources/js/components/toogle-password.js":
/*!****************************************************!*\
  !*** ./resources/js/components/toogle-password.js ***!
  \****************************************************/
/***/ (() => {

var toogle_password = document.querySelectorAll(".toogle-password");

var tooglePassword = function tooglePassword() {
  toogle_password.forEach(function (element) {
    element.addEventListener("click", function () {
      var parent = element.parentElement;
      var password = parent.querySelector("input");
...
/*!************************************!*\
  ...
  \************************************/
__webpack_require__(/*! ./components/select-pegawai */ "./resources/js/components/select-pegawai.js");

__webpack_require__(/*! ./components/toogle-password */ "./resources/js/components/toogle-password.js");
